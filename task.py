...
@author: J.O. Rombouts (see https://github.com/JRombouts/augment)
"""
...
class Task(object):
    ...
    def __init__(self, int_duration, mem_duration, **kwargs):
        """
        ...
        self.intertrial_dur = int_duration # Number of time steps between trials
        self.fix_dur = 0  # Required duration of fixation
        self.mem_dur = mem_duration  # Number of delay steps

        # Set these to allow for random length memory delays
        self.min_mem_dur = mem_duration
        self.max_mem_dur = mem_duration
...
class GGSA(Task):
    ...
    def __init__(self, **kwargs):
        ...
        super(GGSA, self).__init__(int_duration = kwargs.get('inter_dur', 0.),mem_duration = kwargs.get('memory_dur', 2.), **kwargs)
